...
<div class="panel">
    <div class="panel-heading">
        ...
        &nbsp;
        {l s='Stock available' mod='mpstock'}
        &nbsp;
        <span class="badge">{$stock_found} {l s='products' mod='mpstock'}</span>
        <span class="badge">
            {assign var=cur_rec value=$stock_page*$stock_pagination}
            {assign var=last_rec value=$cur_rec+$stock_pagination}
            {l s='records from' mod='mpstock'}&nbsp;<span id="cur_rec">{$cur_rec+1}</span>&nbsp;{l s='to' mod='mpstock'}&nbsp;<span id="last_rec">{$last_rec}</span>
        </span>
    </div>
    <div class="panel-body" id="table-stock">
        {include file="./table-stock.tpl"}
    </div>
</div>
